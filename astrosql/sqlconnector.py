...
def connect(database=None, user=None, password=None, host=None):
    ...
    assert (
        database
    ), "No database provided in argument or configuration. Please check argument or 'config.yml'"
    assert (
        host
    ), "No host provided in argument or configuration. Please check argument or 'config.yml'"
